...
export const routes={"/":HomePage,"/login":LoginPage,"/reset-password":ResetPasswordPage,"/auth/callback":AuthCallbackPage,"/tips":TipsPage,"/bonuses":BonusPage,"/leaderboard":LeaderboardPage,"/profile":ProfilePage,"/profile/edit":EditProfilePage,"/stats":StatsPage,"/history":HistoryPage,"/admin":AdminPage,"/admin/results":ResultsPage,"/admin/scoring":ScoreModelPage,"/admin/bonuses":BonusSettingsPage,"/admin/payments":PaymentsPage};
